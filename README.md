...
`**` In addition to 14 chromosomes, there was also data on the mitochondrial genome and apicoplast genome, but there was only one region with ZH-SCORE >= 500, so they were not considered.  
