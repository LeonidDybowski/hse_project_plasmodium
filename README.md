...
Аналогичным образом были проанализированы квадруплексы. Для их нахождения была использована библиотека pqsfinder и код на R (в папке src).
...
К сожалению, квадруплексов было ещё меньше и они были распределены неравномерно. Так у plasmodium knowlesi и plasmodium vivax их в разы больше (что коррелирует с количеством Z-ДНК).
